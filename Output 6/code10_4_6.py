...
categories = ["comp.graphics", "sci.space", "rec.sport.baseball", "sci.med", "talk.religion.misc", "rec.autos"]
...
n_hidden_4 = 10     # 4th layer number of features
...
def multilayer_perceptron(input_tensor, weights, biases):
    ...
    # Output layer
    out_layer_multiplication = tf.matmul(layer_4, weights['out'])
